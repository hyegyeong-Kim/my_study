          ...
          <tr>
            ...
            <td colspan="3">
              ...
              <span class="el-radio">
                ...
                <label for="radio2">정상</label>
              </span>
              <span class="el-radio">
                <input id="radio3" type="radio" name="radioName" />
                <label for="radio3">오류</label>
              </span>
            </td>
          </tr>
        </tbody><!-- Add 23-10-19 tbody -->
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>1</td>
            <td>
              <span class="ellipsis">mySUNI 이용 안내 드립니다. mySUNI 회원 체계 개편으로 통합 ID 전환이 필요합니다. 로그인 후 통합 ID로 전환을 진행해 주시기 바랍니다</span>
            </td>
            <td>정상</td>
            <td>1,000</td>
            <td></td>
