...
<template>
  <div class="page-layout">
    <div class="title-box">
      ...
      <p class="paragraph">안전한 비밀번호를 사용하여, 개인정보를 더 강력하게 보호하세요.</p>
    </div>
      ...
      <form>
        <article>
          <div class="border-wrap">
            <strong class="title">현재 비밀번호</strong>
            <CInputs :id="'passwordCurrent'" :type="'password'" :placeholder="'비밀번호를 입력하세요.'" :label="'비밀번호'" :value="''" :disabled="false" :readonly="false" />
        ...
        <div class="button-box">
          ...
          <CButtons class="big gray" :title="'비밀번호 변경'" disabled />
          <CButtons class="big point" :title="'비밀번호 변경'" />
        </div>
      </form>
    </div>
  </div>
